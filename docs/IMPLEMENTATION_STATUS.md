...
- Address, map-selected coordinates, nearby discovery, sports, amenities, pricing, and media fields
- One-off and bulk-generated availability slots with overlap prevention
...
### Events and matches
- Organizer event creation on an approved turf and reserved availability slot, plus cancellation/slot release
...
- Player registration, leaving, rejoining, and event conversation membership
- Organizer registration view, automatic/manual fixtures, scores, and results
...
- MySQL + Flyway migrations `V1` through `V6`
- Local image adapter
...
- A production map/geocoding service (Google Maps, Mapbox, or a managed/self-hosted OpenStreetMap stack); a light Nominatim/OpenStreetMap development adapter is included
