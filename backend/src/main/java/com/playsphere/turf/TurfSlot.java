...
public class TurfSlot {
    ...
    public TurfSlot(String turfId, Instant startAt, Instant endAt, BigDecimal price) {
        this.id = Ids.uuid();
        this.turfId = turfId;
    ...
    public void reserveForEvent() { status = "EVENT_RESERVED"; }
    public void release() { status = "AVAILABLE"; }
    public void block() { status = "BLOCKED"; }
    public void makeAvailable() { status = "AVAILABLE"; }
}
